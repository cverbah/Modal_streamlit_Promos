...
def extract_discount(string):
    """
    extracts a discount pattern from string
    """
    pattern = r'\b\d+(?:\.\d+)?%'
...
def analyze_data(df: pd.DataFrame):
    """
    extracts data from column promo_analysis (generated by AI assistant) by creating new columns in the dataframe
    """
    # json to cols
...
def analyze_promo_v2(image_path, format=True, model=gcp_model):
    """AI Assistant that analyze an image url and extracts data from it"""
